...
export type WindowType = "picture" | "notes"| "clock" | "todo-list" | "empty" | "chibbidibbey" | "random-color" | "random-idea" | "roll-dice" | "toilet-paper" | "fortune-cookie" | "pomodoro-timer" | "youtube-video" | "embroidery-slideshow" | "cooking-recipe" | "often-used-links" | "scribbles" | "clicker" | "doodle" | "roadmap" | "fill-game"
    ...
    return (
        <div className="window-options">
            ...
            <div className="options-grid">
                ...
                <button className="window-type-button" onClick={() => onAddWindow("cooking-recipe")}>Your cooking recipes</button>
            </div>
            ...
            <div className="options-grid">
                ...
                <button className="window-type-button" onClick={() => onAddWindow("fill-game")}>Fill Game</button>
